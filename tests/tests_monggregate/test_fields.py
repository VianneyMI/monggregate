...
class TestFieldName:
    ...
    def test_validate_valid_field_name(self) -> None:
    ...
    def test_validate_invalid_field_name_with_dollar(self) -> None:
    ...
    def test_validate_invalid_field_name_with_dot(self) -> None:
    ...
    def test_validate_edge_case_empty_string(self) -> None:
...
class TestFieldPath:
    ...
    def test_validate_invalid_field_path(self) -> None:
