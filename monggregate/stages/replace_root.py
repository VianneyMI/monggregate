...
from monggregate.utils import validates_field_path
...
class ReplaceRoot(Stage):
    ...
    # Validators
    # ---------------------------
    _validates_path_to_new_root = validator("path_to_new_root", allow_reuse=True, pre=True, always=True)(validates_field_path)
